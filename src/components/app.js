...
class App extends React.Component{
    ...
    handleRemove(index){
        ...
        comments_copy.splice(index, 1)
        this.setState({comments: comments_copy});
    }
            ...
            <div className="container app">
                <form className="app--form" onSubmit={this.addComment}>
                    ...
                    <div className="form-submit">
                        <button className="btn btn-primary" type="submit">Enviar <i className="fas fa-arrow-right"></i></button>
                    </div>
                </form>
                <div>
